...
/**
 * @brief	This is our entry point when we're calling
 *jbox.make_native_object_rw from realtime_controller.lua.
 * @details	Note that we pass a parameter - the instance id. The code below
 *demonstrates how to it up even though we currently don't use it.
 */
...
/**
 * @brief	This is the callback we get from Reason/Recon to do our audio
 * rendering
 */
